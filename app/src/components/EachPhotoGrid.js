...
class EachPhotoGrid extends Component {
  constructor(props) {
    super(props);
  ...
  changeToSlide(object) {
    ...
    console.log("ThIS IS THE DATE : ", this.props.eachPhotogridDates)
    const result = [];
    this.props.eachPhotogridDates.forEach(date => {
...
export default connect(mapStateToProps, matchDispatchToProps)(EachPhotoGrid);
